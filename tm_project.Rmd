...
Similar to novels, songs seem to share a long tail distribution in word frequency. Some words are more common and appear more frequently and there are words that make the songs more unique. We will explore them further on the analysis. We can also confirm that this phenomenon is steady throughout each year by looking at the graph below of the word distribution by year.
